...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println(employee1List.stream().sorted(Comparator.comparing(Employee1::getName)).collect(Collectors.toList()));


        employee1List.stream().collect(Collectors.groupingBy(Employee1::getDepartment,Collectors.counting()));
    }
}